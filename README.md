...
# Testing scripts
```python main.py --seed 10 --max_time_steps 1000 --map map.txt --num_agents 4 --n_packages 4```

```python main.py --seed 10 --max_time_steps 1000 --map map2.txt --num_agents 5 --n_packages 5```
...
```python main.py --seed 10 --max_time_steps 1000 --map map5.txt --num_agents 2 --n_packages 2```
